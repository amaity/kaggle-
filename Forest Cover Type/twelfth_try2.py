...
et = Classifier(dataset=dataset, use_cache=CACHE, estimator=ExtraTreesClassifier, parameters=et_param,name='et')
...
lr1_params = {'C': 5, 'random_state' : 1, 'solver' : 'liblinear', 'multi_class' : 'ovr',}
stacker = Classifier(dataset=stack_ds, estimator=lr1, use_cache=False, parameters=lr1_params)
